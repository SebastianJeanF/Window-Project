						...
						<div className=' container  m-auto md:flex px-6 text-gray-600 md:px-12 xl:px-6'>
							<div className='space-y-6 md:space-y-0 flex flex-col xl:items-center xl:flex-row-reverse gap-6  xl:gap-12'>
								<div className='text-textPrimary'>
									...
									<div style={{ fontSize: 'clamp(0.75rem, 1vw + 0.5rem, 1rem)' }}>
								...
								<div className='text-textPrimary'>
									...
									<div style={{ fontSize: 'clamp(0.75rem, 1vw + 0.5rem, 1rem)' }}>
										...
										<div className='mt-4'>
											...
											that{' '}
											<span className='text-blue-700 underline'> our instant quote system</span> is
											just one way we can achieve that goal.
										</div>
									</div>
								</div>
